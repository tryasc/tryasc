...
const Announcements = () => {
  ...
  return (
    <div className="announcements">
      ...
      <p>In order to help families who have been affected financially during this time, we have opted to use a lower quality uniform to lower the registration costs for 2020.</p>

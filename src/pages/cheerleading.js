...
const CheerleadingPage = () => (
  <Layout>
    ...
    <p>
      TRYA offers youth cheerleading for 5-12 year olds. We strive to recruit
    ...
    <p>
      TRYA offers cheerleading for kids age 5-12. Your child must be between 5
      and 12 on or before August 31st of the current year. Cheerleaders will be
      put in squads based age division cutoff dates of August 31 of the current
    ...
    <p>
      ...
      Uniforms, poms, bows, etc, will be provided by TRYA.
    </p>
    ...
    <p>
      Game schedules are set by Greenville Rec and are released in late August.
      Typically, the first game is in early September. 6U and 8u typically have
      games on Saturday. 10u and 12u typically have games on Monday, Tuesday or
      Thursday at 6:30pm and 8:00pm, respectively. Please note these days and
